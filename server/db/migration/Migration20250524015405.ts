...
export class Migration20250524015405 extends Migration {
  override async up(): Promise<void> {
    ...
    `)
    this.addSql(/* sql */ `
      create table if not exists setting_entity (${e("key")} varchar(255) not null, ${e("value")} text not null, primary key (${e("key")})) default character set utf8mb4 engine = InnoDB;
    `)
    this.addSql(/* sql */ `
      create table if not exists static_data_entity (${e("type")} varchar(255) not null, ${e("value")} longtext not null, primary key (${e("type")})) default character set utf8mb4 engine = InnoDB;
    `)
    this.addSql(/* sql */ `
